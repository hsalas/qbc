'''dictionary with names and hexcodes for the xkcd color survey
...
def get_xkcd_color(name):
    ...
    return(xkcd_rgb[name])
 
def xkcd_color_list(banned=[]):
    '''Generates a list with the hexcodes for all the colors in the xkcd survey
    inputs:
    banned (list): Optional. Colornames to be excluded from the list
    '''
    hex_list = []
    for key in xkcd_rgb:
